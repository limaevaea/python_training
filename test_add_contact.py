...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_form(wd, firstname="Limaeva", middlename="Ekaterina", lastname="Alexandrovna", nickname="kvakva", title="w", company="company123",
    ...
    def fill_contact_form(self, wd, firstname, middlename, lastname, nickname, title, company, address, home_telephone,
                          email, birth_date, birth_month, birth_year):
        ...
        Select(wd.find_element_by_name("bday")).select_by_visible_text(birth_date)
